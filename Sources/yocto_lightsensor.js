/*********************************************************************
 *
 * $Id: yocto_lightsensor.js 11112 2013-04-16 14:51:20Z mvuilleu $
 *
...
(function()
{
    ...
    function YLightSensor_set_resolution(newval)
    {   var rest_val;
        rest_val = String(Math.round(newval*65536.0));
    ...
    function _YLightSensor(str_func)
    {
        ...
        this.set_resolution                  = YLightSensor_set_resolution;
        this.setResolution                   = YLightSensor_set_resolution;
