/*********************************************************************
 *
 * $Id: yocto_voc.js 13065 2013-10-10 16:04:55Z mvuilleu $
 *
...
(function()
{
    ...
    /**
     * Gets the logical name of the Volatile Organic Compound sensor.
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YVoc object that invoked the callback
     *         - the result:a string corresponding to the logical name of the Volatile Organic Compound sens
    ...
    /**
     * Gets the current value of the Volatile Organic Compound sensor (no more than 6 characters).
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YVoc object that invoked the callback
     *         - the result:a string corresponding to the current value of the Volatile Organic Compound sensor
     *         (no more than 6 character
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
    ...
    YVoc = _YVoc;
    YVoc.LOGICALNAME_INVALID             = "!INVALID!";
    YVoc.ADVERTISEDVALUE_INVALID         = "!INVALID!";
    YVoc.UNIT_INVALID                    = "!INVALID!";
    YVoc.CURRENTVALUE_INVALID            = -Number.MAX_VALUE;
    YVoc.LOWESTVALUE_INVALID             = -Number.MAX_VALUE;
    YVoc.HIGHESTVALUE_INVALID            = -Number.MAX_VALUE;
    YVoc.CURRENTRAWVALUE_INVALID         = -Number.MAX_VALUE;
    YVoc.CALIBRATIONPARAM_INVALID        = "!INVALID!";
    YVoc.RESOLUTION_INVALID              = -Number.MAX_VALUE;
    YVoc._calibrationOffset              = 0;
