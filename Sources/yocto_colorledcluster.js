/*********************************************************************
 *
 * $Id: yocto_colorledcluster.js 24475 2016-05-12 14:03:35Z mvuilleu $
 *
...
(function()
{
     ...
     *         On failure, throws an exception or returns a negative error code.
     */
    function YColorLedCluster_set_blinkSeqAutoStart(seqIndex,autostart)
    {
        return this.sendCommand("AS"+String(Math.round(seqIndex))+","+(autostart?"1":"0"));
    }
    ...
    YColorLedCluster = YFunction._Subclass(_YColorLedCluster, {
        ...
        set_blinkSeqAutoStart       : YColorLedCluster_set_blinkSeqAutoStart,
        setBlinkSeqAutoStart        : YColorLedCluster_set_blinkSeqAutoStart,
