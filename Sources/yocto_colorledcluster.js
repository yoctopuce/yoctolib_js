/*********************************************************************
 *
 * $Id: yocto_colorledcluster.js 24149 2016-04-22 07:02:18Z mvuilleu $
 *
...
(function()
{
    ...
    /**
     * Gets the count of LEDs currently handled by the device.
     *
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YColorLedCluster object that invoked the callback
     *         - the result:an integer corresponding to the count of LEDs currently handled by the device
    ...
    /**
     * Gets the maximum count of LEDs that the device can handle.
     *
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YColorLedCluster object that invoked the callback
     *         - the result:an integer corresponding to the maximum count of LEDs that the device can handle
     * @param context : user-specific object that is passed as-is to the callback function
     *
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     *
    ...
    /**
     * Gets the maximum count of sequences.
     *
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YColorLedCluster object that invoked the callback
     *         - the result:an integer corresponding to the maximum count of sequences
     * @param context : user-specific object that is passed as-is to the callback function
     *
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     *
     ...
     *         On failure, throws an exception or returns a negative error code.
     */
    function YColorLedCluster_changeBlinkSeqSpeed(seqIndex,speed)
    {
        return this.sendCommand("CS"+String(Math.round(seqIndex)));
    }
     ...
     *         On failure, throws an exception or returns a negative error code.
     */
    function YColorLedCluster_set_rgbBuffer(buff)
    {
     ...
     *         On failure, throws an exception or returns a negative error code.
     */
    function YColorLedCluster_set_rgbArray(rgbList)
    {
        var listlen;                // int;
        var buff;                   // bin;
        var idx;                    // int;
     ...
     *         On failure, throws an exception or returns a negative error code.
     */
    function YColorLedCluster_set_hslBuffer(buff)
    {
     ...
     *         On failure, throws an exception or returns a negative error code.
     */
    function YColorLedCluster_set_hslArray(hslList)
    {
        var listlen;                // int;
        var buff;                   // bin;
        var idx;                    // int;
    ...
    function YColorLedCluster_get_rgbColorArray(ledIndex,count)
    {
        ...
        idx = 0;
        while (idx < count) {
            r = (buff).charCodeAt(3*idx);
            g = (buff).charCodeAt(3*idx+1);
            b = (buff).charCodeAt(3*idx+2);
    ...
    YColorLedCluster = YFunction._Subclass(_YColorLedCluster, {
        ...
        changeBlinkSeqSpeed         : YColorLedCluster_changeBlinkSeqSpeed,
        saveLedsState               : YColorLedCluster_saveLedsState,
        set_rgbBuffer               : YColorLedCluster_set_rgbBuffer,
        setRgbBuffer                : YColorLedCluster_set_rgbBuffer,
        set_rgbArray                : YColorLedCluster_set_rgbArray,
        setRgbArray                 : YColorLedCluster_set_rgbArray,
        rgbArray_move               : YColorLedCluster_rgbArray_move,
        set_hslBuffer               : YColorLedCluster_set_hslBuffer,
        setHslBuffer                : YColorLedCluster_set_hslBuffer,
        set_hslArray                : YColorLedCluster_set_hslArray,
        setHslArray                 : YColorLedCluster_set_hslArray,
