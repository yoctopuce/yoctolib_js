/*********************************************************************
 *
 * $Id: yocto_humidity.js 13065 2013-10-10 16:04:55Z mvuilleu $
 *
...
(function()
{
    ...
    /**
     * Gets the logical name of the humidity sensor.
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YHumidity object that invoked the callback
     *         - the result:a string corresponding to the logical name of the humidity sens
    ...
    /**
     * Gets the current value of the humidity sensor (no more than 6 characters).
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YHumidity object that invoked the callback
     *         - the result:a string corresponding to the current value of the humidity sensor (no more than 6 character
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
    ...
    YHumidity.LOGICALNAME_INVALID             = "!INVALID!";
    YHumidity.ADVERTISEDVALUE_INVALID         = "!INVALID!";
    YHumidity.UNIT_INVALID                    = "!INVALID!";
    YHumidity.CURRENTVALUE_INVALID            = -Number.MAX_VALUE;
    YHumidity.LOWESTVALUE_INVALID             = -Number.MAX_VALUE;
    YHumidity.HIGHESTVALUE_INVALID            = -Number.MAX_VALUE;
    YHumidity.CURRENTRAWVALUE_INVALID         = -Number.MAX_VALUE;
    YHumidity.CALIBRATIONPARAM_INVALID        = "!INVALID!";
    YHumidity.RESOLUTION_INVALID              = -Number.MAX_VALUE;
    YHumidity._calibrationOffset              = 0;
