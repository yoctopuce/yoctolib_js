/*********************************************************************
 *
 * $Id: yocto_network.js 13065 2013-10-10 16:04:55Z mvuilleu $
 *
...
(function()
{
    ...
    /**
     * Gets the logical name of the network interface, corresponding to the network name of the module.
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YNetwork object that invoked the callback
     *         - the result:a string corresponding to the logical name of the network interface, corresponding to
     *         the network name of the modu
    ...
    /**
     * Gets the current value of the network interface (no more than 6 characters).
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YNetwork object that invoked the callback
     *         - the result:a string corresponding to the current value of the network interface (no more than 6 character
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YNetwork object that invoked the callback
     *         - the result:a string corresponding to the MAC address of the network interfa
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YNetwork object that invoked the callback
     *         - the result:a string corresponding to the IP address currently in use by the devi
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YNetwork object that invoked the callback
     *         - the result:a string corresponding to the subnet mask currently used by the devi
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YNetwork object that invoked the callback
     *         - the result:a string corresponding to the IP address of the router on the device subnet (default gatewa
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YNetwork object that invoked the callback
     *         - the result:a string corresponding to the IP address of the primary name server to be used by the modu
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YNetwork object that invoked the callback
     *         - the result:a string corresponding to the IP address of the secondary name server to be used by the modu
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         discovery of the module in the network neighborhood (uPnP/Bonjour protoco
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         triggering an automated
     *         reboot to try to recover Internet connectivi
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YNetwork object that invoked the callback
     *         - the result:a string corresponding to the callback URL to notify of significant state chang
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         corresponding to the HTTP method used to notify callbacks for significant state chang
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         Y_CALLBACKENCODING_JSON_ARRAY, Y_CALLBACKENCODING_CSV and Y_CALLBACKENCODING_YOCTO_API
     *         corresponding to the encoding standard to use for representing notification valu
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YNetwork object that invoked the callback
     *         - the result:an integer corresponding to the minimum waiting time between two callback notifications, in secon
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YNetwork object that invoked the callback
     *         - the result:an integer corresponding to the maximum waiting time between two callback notifications, in secon
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         Power-over-Ethernet (PoE), in milli-am
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
    ...
    YNetwork = _YNetwork;
    YNetwork.LOGICALNAME_INVALID             = "!INVALID!";
    YNetwork.ADVERTISEDVALUE_INVALID         = "!INVALID!";
    ...
    YNetwork.MACADDRESS_INVALID              = "!INVALID!";
    YNetwork.IPADDRESS_INVALID               = "!INVALID!";
    YNetwork.SUBNETMASK_INVALID              = "!INVALID!";
    YNetwork.ROUTER_INVALID                  = "!INVALID!";
    YNetwork.IPCONFIG_INVALID                = "!INVALID!";
    YNetwork.PRIMARYDNS_INVALID              = "!INVALID!";
    YNetwork.SECONDARYDNS_INVALID            = "!INVALID!";
    YNetwork.USERPASSWORD_INVALID            = "!INVALID!";
    YNetwork.ADMINPASSWORD_INVALID           = "!INVALID!";
    YNetwork.DISCOVERABLE_FALSE              = 0;
    YNetwork.DISCOVERABLE_TRUE               = 1;
    YNetwork.DISCOVERABLE_INVALID            = -1;
    YNetwork.WWWWATCHDOGDELAY_INVALID        = -1;
    YNetwork.CALLBACKURL_INVALID             = "!INVALID!";
    ...
    YNetwork.CALLBACKCREDENTIALS_INVALID     = "!INVALID!";
    YNetwork.CALLBACKMINDELAY_INVALID        = -1;
    YNetwork.CALLBACKMAXDELAY_INVALID        = -1;
    YNetwork.POECURRENT_INVALID              = -1;
