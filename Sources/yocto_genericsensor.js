/*********************************************************************
 *
 * $Id: yocto_genericsensor.js 13065 2013-10-10 16:04:55Z mvuilleu $
 *
...
(function()
{
    ...
    /**
     * Gets the logical name of the generic sensor.
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YGenericSensor object that invoked the callback
     *         - the result:a string corresponding to the logical name of the generic sens
     ...
     */
    function YGenericSensor_set_logicalName(newval)
    {   var rest_val;
        rest_val = newval;
    ...
    /**
     * Gets the current value of the generic sensor (no more than 6 characters).
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YGenericSensor object that invoked the callback
     *         - the result:a string corresponding to the current value of the generic sensor (no more than 6 character
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    function YGenericSensor_set_lowestValue(newval)
    {   var rest_val;
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    function YGenericSensor_set_highestValue(newval)
    {   var rest_val;
        rest_val = String(Math.round(newval*65536.0));
    ...
    function YGenericSensor_set_calibrationParam(newval)
    {   var rest_val;
        rest_val = newval;
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    function YGenericSensor_calibrateFromPoints(floatArr_rawValues,floatArr_refValues)
    {   var rest_val;
        rest_val = this._encodeCalibrationPoints(floatArr_rawValues,floatArr_refValues);
        return this._setAttr('calibrationParam',rest_val);
    }

    function YGenericSensor_loadCalibrationPoints(floatArrRef_rawValues,floatArrRef_refValues)
    {
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    function YGenericSensor_set_resolution(newval)
    {   var rest_val;
        rest_val = String(Math.round(newval*65536.0));
     ...
     *         - the user-specific context object
     *         - the YGenericSensor object that invoked the callback
     *         - the result:a string corresponding to the measuring unit of the electrical signal used by the sens
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YGenericSensor object that invoked the callback
     *         - the result:a string corresponding to the electric signal range used by the sens
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YGenericSensor object that invoked the callback
     *         - the result:a string corresponding to the physical value range measured by the sens
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
    ...
    function _YGenericSensor(str_func)
    {
        ...
        this.set_logicalName                 = YGenericSensor_set_logicalName;
        this.setLogicalName                  = YGenericSensor_set_logicalName;
        ...
        this.set_unit                        = YGenericSensor_set_unit;
        this.setUnit                         = YGenericSensor_set_unit;
        ...
        this.set_lowestValue                 = YGenericSensor_set_lowestValue;
        this.setLowestValue                  = YGenericSensor_set_lowestValue;
        ...
        this.set_highestValue                = YGenericSensor_set_highestValue;
        this.setHighestValue                 = YGenericSensor_set_highestValue;
        ...
        this.set_calibrationParam            = YGenericSensor_set_calibrationParam;
        this.setCalibrationParam             = YGenericSensor_set_calibrationParam;
        this.calibrateFromPoints             = YGenericSensor_calibrateFromPoints;
        this.loadCalibrationPoints           = YGenericSensor_loadCalibrationPoints;
        this.set_resolution                  = YGenericSensor_set_resolution;
        this.setResolution                   = YGenericSensor_set_resolution;
        ...
        this.set_signalRange                 = YGenericSensor_set_signalRange;
        this.setSignalRange                  = YGenericSensor_set_signalRange;
        ...
        this.set_valueRange                  = YGenericSensor_set_valueRange;
        this.setValueRange                   = YGenericSensor_set_valueRange;
        this.nextGenericSensor               = YGenericSensor_nextGenericSensor;
        //--- (end of YGenericSensor constructor)
    }

    YGenericSensor = _YGenericSensor;
    YGenericSensor.LOGICALNAME_INVALID             = "!INVALID!";
    YGenericSensor.ADVERTISEDVALUE_INVALID         = "!INVALID!";
    YGenericSensor.UNIT_INVALID                    = "!INVALID!";
    YGenericSensor.CURRENTVALUE_INVALID            = -Number.MAX_VALUE;
    YGenericSensor.LOWESTVALUE_INVALID             = -Number.MAX_VALUE;
    YGenericSensor.HIGHESTVALUE_INVALID            = -Number.MAX_VALUE;
    YGenericSensor.CURRENTRAWVALUE_INVALID         = -Number.MAX_VALUE;
    YGenericSensor.CALIBRATIONPARAM_INVALID        = "!INVALID!";
    YGenericSensor.RESOLUTION_INVALID              = -Number.MAX_VALUE;
    YGenericSensor.SIGNALVALUE_INVALID             = -Number.MAX_VALUE;
    YGenericSensor.SIGNALUNIT_INVALID              = "!INVALID!";
    YGenericSensor.SIGNALRANGE_INVALID             = "!INVALID!";
    YGenericSensor.VALUERANGE_INVALID              = "!INVALID!";
    YGenericSensor._calibrationOffset              = 0;
