/*********************************************************************
 *
 * $Id: yocto_dualpower.js 13065 2013-10-10 16:04:55Z mvuilleu $
 *
...
(function()
{
    ...
    /**
     * Gets the logical name of the power control.
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YDualPower object that invoked the callback
     *         - the result:a string corresponding to the logical name of the power contr
    ...
    /**
     * Gets the current value of the power control (no more than 6 characters).
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YDualPower object that invoked the callback
     *         - the result:a string corresponding to the current value of the power control (no more than 6 character
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         corresponding to the current power source for module functions that require lots of curre
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YDualPower object that invoked the callback
     *         - the result:an integer corresponding to the measured voltage on the external power source, in millivol
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
    ...
    YDualPower.LOGICALNAME_INVALID             = "!INVALID!";
    YDualPower.ADVERTISEDVALUE_INVALID         = "!INVALID!";
    ...
    YDualPower.EXTVOLTAGE_INVALID              = -1;
