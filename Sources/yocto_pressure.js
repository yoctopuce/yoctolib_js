/*********************************************************************
 *
 * $Id: yocto_pressure.js 11112 2013-04-16 14:51:20Z mvuilleu $
 *
...
(function()
{
    ...
    function YPressure_set_resolution(newval)
    {   var rest_val;
        rest_val = String(Math.round(newval*65536.0));
    ...
    function _YPressure(str_func)
    {
        ...
        this.set_resolution                  = YPressure_set_resolution;
        this.setResolution                   = YPressure_set_resolution;
