/*********************************************************************
 *
 * $Id: yocto_pressure.js 13065 2013-10-10 16:04:55Z mvuilleu $
 *
...
(function()
{
    ...
    /**
     * Gets the logical name of the pressure sensor.
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YPressure object that invoked the callback
     *         - the result:a string corresponding to the logical name of the pressure sens
    ...
    /**
     * Gets the current value of the pressure sensor (no more than 6 characters).
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YPressure object that invoked the callback
     *         - the result:a string corresponding to the current value of the pressure sensor (no more than 6 character
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
    ...
    YPressure.LOGICALNAME_INVALID             = "!INVALID!";
    YPressure.ADVERTISEDVALUE_INVALID         = "!INVALID!";
    YPressure.UNIT_INVALID                    = "!INVALID!";
    YPressure.CURRENTVALUE_INVALID            = -Number.MAX_VALUE;
    YPressure.LOWESTVALUE_INVALID             = -Number.MAX_VALUE;
    YPressure.HIGHESTVALUE_INVALID            = -Number.MAX_VALUE;
    YPressure.CURRENTRAWVALUE_INVALID         = -Number.MAX_VALUE;
    YPressure.CALIBRATIONPARAM_INVALID        = "!INVALID!";
    YPressure.RESOLUTION_INVALID              = -Number.MAX_VALUE;
    YPressure._calibrationOffset              = 0;
