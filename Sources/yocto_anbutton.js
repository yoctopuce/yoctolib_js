/*********************************************************************
 *
 * $Id: yocto_anbutton.js 13065 2013-10-10 16:04:55Z mvuilleu $
 *
...
(function()
{
    ...
    /**
     * Gets the logical name of the analog input.
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YAnButton object that invoked the callback
     *         - the result:a string corresponding to the logical name of the analog inp
    ...
    /**
     * Gets the current value of the analog input (no more than 6 characters).
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YAnButton object that invoked the callback
     *         - the result:a string corresponding to the current value of the analog input (no more than 6 character
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YAnButton object that invoked the callback
     *         - the result:an integer corresponding to the current calibrated input value (between 0 and 1000, include
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YAnButton object that invoked the callback
     *         - the result:an integer corresponding to the current measured input value as-is (between 0 and 4095, include
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YAnButton object that invoked the callback
     *         - the result:either Y_ANALOGCALIBRATION_OFF or Y_ANALOGCALIBRATION_
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         (considered as binary) is active (closed contact), and false otherwi
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         the input button was pressed (the input contact transitionned from open to close
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the result:an integer corresponding to the number of elapsed milliseconds between the module
     *         power on and the last time
     *         the input button was released (the input contact transitionned from closed to ope
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YAnButton object that invoked the callback
     *         - the result:an integer corresponding to the pulse counter val
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         - the user-specific context object
     *         - the YAnButton object that invoked the callback
     *         - the result:an integer corresponding to the timer of the pulses counter (m
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
    ...
    YAnButton.LOGICALNAME_INVALID             = "!INVALID!";
    YAnButton.ADVERTISEDVALUE_INVALID         = "!INVALID!";
    YAnButton.CALIBRATEDVALUE_INVALID         = -1;
    YAnButton.RAWVALUE_INVALID                = -1;
    YAnButton.ANALOGCALIBRATION_OFF           = 0;
    YAnButton.ANALOGCALIBRATION_ON            = 1;
    YAnButton.ANALOGCALIBRATION_INVALID       = -1;
    YAnButton.CALIBRATIONMAX_INVALID          = -1;
    YAnButton.CALIBRATIONMIN_INVALID          = -1;
    YAnButton.SENSITIVITY_INVALID             = -1;
    YAnButton.ISPRESSED_FALSE                 = 0;
    YAnButton.ISPRESSED_TRUE                  = 1;
    YAnButton.ISPRESSED_INVALID               = -1;
    YAnButton.LASTTIMEPRESSED_INVALID         = -1;
    YAnButton.LASTTIMERELEASED_INVALID        = -1;
    YAnButton.PULSECOUNTER_INVALID            = -1;
    YAnButton.PULSETIMER_INVALID              = -1;
