...
(function()
{
     ...
     *         - the user-specific context object
     *         - the YRefFrame object that invoked the callback
     *         - the result:a value among YRefFrame.FUSIONMODE_NDOF, YRefFrame.FUSIONMODE_NDOF_FMC_OFF,
     *         YRefFrame.FUSIONMODE_M4G, YRefFrame.FUSIONMODE_COMPASS, YRefFrame.FUSIONMODE_IMU,
     *         YRefFrame.FUSIONMODE_INCLIN_90DEG_1G8, YRefFrame.FUSIONMODE_INCLIN_90DEG_3G6 and
     *         YRefFrame.FUSIONMODE_INCLIN_10DEG corresponding to the sensor fusion mode
     * @param context : user-specific object that is passed as-is to the callback function
     ...
     */
    function YRefFrame_get_calibrationState()
    {
        var calibParam;             // str;
        var iCalib = [];            // intArr;
        var caltyp;                 // int;
     ...
     * For the Yocto-3D (V1), this function always return -3 (unsupported function).
     */
    function YRefFrame_get_measureQuality()
    {
        var calibParam;             // str;
        var iCalib = [];            // intArr;
        var caltyp;                 // int;
    ...
    function YRefFrame_more3DCalibrationV1()
    {
        var currTick;               // int;
        var jsonData;               // bin;
        var xVal;                   // float;
    ...
    function YRefFrame_more3DCalibrationV2()
    {
        var currTick;               // int;
        var calibParam;             // bin;
        var iCalib = [];            // intArr;
    ...
    function YRefFrame_save3DCalibrationV1()
    {
        var shiftX;                 // int;
        var shiftY;                 // int;
        var shiftZ;                 // int;
    ...
    function YRefFrame_save3DCalibrationV2()
    {
    ...
    YRefFrame = YFunction._Subclass(_YRefFrame, {
        ...
        get_calibrationState        : YRefFrame_get_calibrationState,
        calibrationState            : YRefFrame_get_calibrationState,
        get_measureQuality          : YRefFrame_get_measureQuality,
        measureQuality              : YRefFrame_get_measureQuality,
        ...
        more3DCalibrationV1         : YRefFrame_more3DCalibrationV1,
        more3DCalibrationV2         : YRefFrame_more3DCalibrationV2,
        ...
        save3DCalibrationV1         : YRefFrame_save3DCalibrationV1,
        save3DCalibrationV2         : YRefFrame_save3DCalibrationV2,
