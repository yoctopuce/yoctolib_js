/*********************************************************************
 *
 * $Id: yocto_cellular.js 62273 2024-08-23 07:20:59Z seb $
 *
...
(function()
{
    ...
    function YCellular_imm_decodePLMN(mccmnc)
    {
        var inputlen;               // int;
        var mcc;                    // int;
        var npos;                   // int;
        ...
        mcc = YAPI._atoi(mccmnc.substr(0, 3));
        if (mcc < 200) {
            return mccmnc;
        }
     ...
     */
    function YCellular_decodePLMN(mccmnc)
    {
