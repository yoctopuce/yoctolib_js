/*********************************************************************
 *
 * $Id: yocto_temperature.js 13065 2013-10-10 16:04:55Z mvuilleu $
 *
...
(function()
{
    ...
    /**
     * Gets the logical name of the temperature sensor.
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YTemperature object that invoked the callback
     *         - the result:a string corresponding to the logical name of the temperature sens
    ...
    /**
     * Gets the current value of the temperature sensor (no more than 6 characters).
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YTemperature object that invoked the callback
     *         - the result:a string corresponding to the current value of the temperature sensor (no more than 6 character
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
     ...
     *         Y_SENSORTYPE_TYPE_J, Y_SENSORTYPE_TYPE_N, Y_SENSORTYPE_TYPE_R, Y_SENSORTYPE_TYPE_S,
     *         Y_SENSORTYPE_TYPE_T, Y_SENSORTYPE_PT100_4WIRES, Y_SENSORTYPE_PT100_3WIRES and
     *         Y_SENSORTYPE_PT100_2WIRES corresponding to the temperature sensor ty
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
    ...
    YTemperature.LOGICALNAME_INVALID             = "!INVALID!";
    YTemperature.ADVERTISEDVALUE_INVALID         = "!INVALID!";
    YTemperature.UNIT_INVALID                    = "!INVALID!";
    YTemperature.CURRENTVALUE_INVALID            = -Number.MAX_VALUE;
    YTemperature.LOWESTVALUE_INVALID             = -Number.MAX_VALUE;
    YTemperature.HIGHESTVALUE_INVALID            = -Number.MAX_VALUE;
    YTemperature.CURRENTRAWVALUE_INVALID         = -Number.MAX_VALUE;
    YTemperature.CALIBRATIONPARAM_INVALID        = "!INVALID!";
    YTemperature.RESOLUTION_INVALID              = -Number.MAX_VALUE;
    ...
    YTemperature._calibrationOffset              = -32767;
