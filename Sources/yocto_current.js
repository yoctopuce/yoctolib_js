/*********************************************************************
 *
 * $Id: yocto_current.js 13065 2013-10-10 16:04:55Z mvuilleu $
 *
...
(function()
{
    ...
    /**
     * Gets the logical name of the current sensor.
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YCurrent object that invoked the callback
     *         - the result:a string corresponding to the logical name of the current sens
    ...
    /**
     * Gets the current value of the current sensor (no more than 6 characters).
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YCurrent object that invoked the callback
     *         - the result:a string corresponding to the current value of the current sensor (no more than 6 character
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
    ...
    YCurrent = _YCurrent;
    YCurrent.LOGICALNAME_INVALID             = "!INVALID!";
    YCurrent.ADVERTISEDVALUE_INVALID         = "!INVALID!";
    YCurrent.UNIT_INVALID                    = "!INVALID!";
    YCurrent.CURRENTVALUE_INVALID            = -Number.MAX_VALUE;
    YCurrent.LOWESTVALUE_INVALID             = -Number.MAX_VALUE;
    YCurrent.HIGHESTVALUE_INVALID            = -Number.MAX_VALUE;
    YCurrent.CURRENTRAWVALUE_INVALID         = -Number.MAX_VALUE;
    YCurrent.CALIBRATIONPARAM_INVALID        = "!INVALID!";
    YCurrent.RESOLUTION_INVALID              = -Number.MAX_VALUE;
    YCurrent._calibrationOffset              = -32767;
