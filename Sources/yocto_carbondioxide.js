/*********************************************************************
 *
 * $Id: yocto_carbondioxide.js 13065 2013-10-10 16:04:55Z mvuilleu $
 *
...
(function()
{
    ...
    /**
     * Gets the logical name of the CO2 sensor.
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YCarbonDioxide object that invoked the callback
     *         - the result:a string corresponding to the logical name of the CO2 sens
    ...
    /**
     * Gets the current value of the CO2 sensor (no more than 6 characters).
     * 
     * @param callback : callback function that is invoked when the result is known.
     *         The callback function receives three arguments:
     *         - the user-specific context object
     *         - the YCarbonDioxide object that invoked the callback
     *         - the result:a string corresponding to the current value of the CO2 sensor (no more than 6 character
     * @param context : user-specific object that is passed as-is to the callback function
     * 
     * @return nothing: this is the asynchronous version, that uses a callback instead of a return value
     * 
    ...
    YCarbonDioxide.LOGICALNAME_INVALID             = "!INVALID!";
    YCarbonDioxide.ADVERTISEDVALUE_INVALID         = "!INVALID!";
    YCarbonDioxide.UNIT_INVALID                    = "!INVALID!";
    YCarbonDioxide.CURRENTVALUE_INVALID            = -Number.MAX_VALUE;
    YCarbonDioxide.LOWESTVALUE_INVALID             = -Number.MAX_VALUE;
    YCarbonDioxide.HIGHESTVALUE_INVALID            = -Number.MAX_VALUE;
    YCarbonDioxide.CURRENTRAWVALUE_INVALID         = -Number.MAX_VALUE;
    YCarbonDioxide.CALIBRATIONPARAM_INVALID        = "!INVALID!";
    YCarbonDioxide.RESOLUTION_INVALID              = -Number.MAX_VALUE;
    YCarbonDioxide._calibrationOffset              = -32767;
